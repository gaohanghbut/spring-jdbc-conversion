 ...
 */
public class ParamMap extends AbstractMap<String, Object> {

  public static ParamMap fromNotNull(Object obj) {
    checkNotNull(obj);
    return new ParamMap(obj);
  }
